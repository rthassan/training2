 ...
 * PLACE ANY CUSTOMIZATIONS IN Rt_Students
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class Rt_Students_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'Rt_Students';
    public $object_name = 'Rt_Students';
    public $table_name = 'rt_students';
     ...
     * @deprecated
     */
    public function Rt_Students_sugar(){
        $GLOBALS['log']->deprecated('Calls to Rt_Students::Rt_Students are deprecated.');
        self::__construct();
    }
