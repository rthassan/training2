 ...
 * PLACE ANY CUSTOMIZATIONS IN Brnch_Branches
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class Brnch_Branches_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'Brnch_Branches';
    public $object_name = 'Brnch_Branches';
    public $table_name = 'brnch_branches';
     ...
     * @deprecated
     */
    public function Brnch_Branches_sugar(){
        $GLOBALS['log']->deprecated('Calls to Brnch_Branches::Brnch_Branches are deprecated.');
        self::__construct();
    }
