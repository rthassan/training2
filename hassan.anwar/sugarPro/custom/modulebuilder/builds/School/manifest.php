...
$manifest = array (
  ...
  'key' => 'Rt',
  'author' => 'Hassan Anwar',
  'description' => 'Package will have following modules:-
School
Student
Staff
Teacher',
  ...
  'name' => 'School',
  'published_date' => '2016-08-10 12:16:08',
  'type' => 'module',
  'version' => 1470831368,
...
$installdefs = array (
  ...
  array (
    ...
    array (
      'module' => 'Rt_Students',
      'class' => 'Rt_Students',
      'path' => 'modules/Rt_Students/Rt_Students.php',
      'tab' => true,
    ),
    1 => 
    array (
      'module' => 'Rt_Schools',
      'class' => 'Rt_Schools',
      'path' => 'modules/Rt_Schools/Rt_Schools.php',
      'tab' => true,
    ),
    2 => 
    array (
      'module' => 'Rt_Staffs',
      'class' => 'Rt_Staffs',
      'path' => 'modules/Rt_Staffs/Rt_Staffs.php',
      'tab' => true,
    ),
    3 => 
    array (
      'module' => 'Rt_Teachers',
      'class' => 'Rt_Teachers',
      'path' => 'modules/Rt_Teachers/Rt_Teachers.php',
      'tab' => true,
    ),
  ),
  'layoutdefs' => 
  ...
  array (
    0 => 
    array (
      'from' => '<basepath>/SugarModules/modules/Rt_Students',
      'to' => 'modules/Rt_Students',
    ),
    1 => 
    array (
      'from' => '<basepath>/SugarModules/modules/Rt_Schools',
      'to' => 'modules/Rt_Schools',
    ),
    2 => 
    array (
      'from' => '<basepath>/SugarModules/modules/Rt_Staffs',
      'to' => 'modules/Rt_Staffs',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/modules/Rt_Teachers',
      'to' => 'modules/Rt_Teachers',
    ),
  ),
  'language' => 
  array (
