 ...
 * PLACE ANY CUSTOMIZATIONS IN Rt_Teachers
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class Rt_Teachers_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'Rt_Teachers';
    public $object_name = 'Rt_Teachers';
    public $table_name = 'rt_teachers';
     ...
     * @deprecated
     */
    public function Rt_Teachers_sugar(){
        $GLOBALS['log']->deprecated('Calls to Rt_Teachers::Rt_Teachers are deprecated.');
        self::__construct();
    }
