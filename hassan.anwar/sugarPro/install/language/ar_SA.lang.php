...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على قاعدة بيانات داعمة.  يُرجى التأكد من أن لديك المحركات اللازمة لأحد أنواع قواعد البيانات التالية: MySQL أو خادم MS SQL.  قد تحتاج إلى عدم التعليق على الامتداد في ملف php.ini، أو إعادة تجميع مع ملف ثنائي صحيح، وفقًا لإصدار PHP الخاص بك.  يُرجى الرجوع إلى دليل PHP الخاص بك للحصول على مزيد من المعلومات عن كيفية تفعيل دعم قاعدة البيانات.<br><br>تعتبر Oracle وDB2 قواعد بيانات غير داعمة لنظام SugarCRM PRO. لقائمة قواعد البيانات الداعمة ومعلومات عن المنصات الأخرى، يُرجى زيارة <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/">http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
