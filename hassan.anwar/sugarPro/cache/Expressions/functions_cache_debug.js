...
/**
 * Construct a new CityExpression.
 */
SUGAR.expressions.CityExpression = function(params, context) {
	this.context = context;
	this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.CityExpression, SUGAR.expressions.StringExpression, {
    className: "CityExpression",
	evaluate: function() {
        var params = this.getParameters();
 ...
 */
SUGAR.FunctionMap = {
	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'log'	:	SUGAR.expressions.LogExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'now'	:	SUGAR.expressions.NowExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'getCity'	:	SUGAR.expressions.CityExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
