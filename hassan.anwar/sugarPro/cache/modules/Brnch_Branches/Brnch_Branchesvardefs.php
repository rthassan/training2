<?php 
 $GLOBALS["dictionary"]["Brnch_Branches"]=array (
  'table' => 'brnch_branches',
  'audited' => true,
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'brnch_branches_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'brnch_branches_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'brnch_branches_activities',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'brnch_branches_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'brnch_branches_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'brnch_branches_email_addresses',
      'source' => 'non-db',
    ...
    array (
      ...
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'brnch_branches_type_dom',
      'len' => 50,
      'duplicate_on_record_copy' => 'always',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_brnch_branches_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_brnch_branches_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_brnch_branches_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'team_set_brnch_branches' => 
    array (
      'name' => 'idx_brnch_branches_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
