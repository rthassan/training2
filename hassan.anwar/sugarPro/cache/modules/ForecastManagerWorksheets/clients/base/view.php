    ...
    <tr>
        ...
        {{#each ../rightColumns}}
            ...
            <th class="nosort morecol">
                <div class="dropdown">
                    <button class="btn btn-invisible" data-toggle="dropdown" rel="tooltip" title="{{str "LBL_COLUMNS"}}" data-placement="bottom" data-action="fields-toggle" track="click:morecol"><i class="fa fa-ellipsis-h"></i></button>
...
',
  ...
  '_hash' => '356b4cb55812adafd391393b0bafecae',
);
